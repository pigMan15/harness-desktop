...
export function NodeCatalog({ nodes, lockedIds, onAddNode, onCreateNode }: Props): React.ReactElement {
  ...
  return <aside className="studio-catalog">
    <div className="studio-pane-title"><strong>Node Catalog</strong><button className="button icon-button" onClick={onCreateNode} title="Create custom node"><Plus size={15} /></button></div>
